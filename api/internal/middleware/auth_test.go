...
func (m *mockAnalyticsRepo) GetDashboardStats(context.Context) (*domain.DashboardStats, error) {
...
func (m *mockAnalyticsRepo) DeleteSearchEventsOlderThan(context.Context, time.Time) error { return nil }
