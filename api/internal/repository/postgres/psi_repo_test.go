...
func TestPsiRepo_ComprehensiveSuite(t *testing.T) {
	...
	t.Run("Advanced Search Logic and Ranking", func(t *testing.T) {
		...
		users := []domain.PsiUserModel{
			{ID: uuid.New(), FirstName: "Pedro", LastName: "Alfonso", CI: 10, FPV: 10, Solvent: true, IsActive: true, Genre: "M", Nationality: "V", ContactEmail: "p1@t.com", MunicipalityCarabobo: "Valencia", PrimarySpecialty: "Neuropsicología", Username: "p1", Email: "p1@t.com", BornDate: now, BioTextID: dummyBio.ID},
			{ID: uuid.New(), FirstName: "Maria", LastName: "Zeta", CI: 20, FPV: 20, Solvent: true, IsActive: true, Genre: "F", Nationality: "V", ContactEmail: "m2@t.com", MunicipalityCarabobo: "San Diego", Username: "m2", Email: "m2@t.com", BornDate: now, BioTextID: dummyBio.ID},
			{ID: uuid.New(), FirstName: "Insolvente", LastName: "Busquedame", CI: 30, FPV: 30, Solvent: false, IsActive: true, Genre: "M", Nationality: "V", ContactEmail: "i3@t.com", Username: "i3", Email: "i3@t.com", BornDate: now, BioTextID: dummyBio.ID},
			{ID: uuid.New(), FirstName: "Baneado", LastName: "Invisible", CI: 40, FPV: 40, Solvent: true, IsActive: false, Genre: "M", Nationality: "V", ContactEmail: "b4@t.com", Username: "b4", Email: "b4@t.com", BornDate: now, BioTextID: dummyBio.ID},
		}
		for i := range users {
	...
	t.Run("Soft Delete and Unscoped Recovery", func(t *testing.T) {
		...
		psi := domain.PsiUserModel{
			...
			Genre: "M", Nationality: "V", ContactEmail: "del@t.com", FirstName: "Del", LastName: "Me",
		}
	...
	t.Run("UpdatePublicProfile with Omit Logic", func(t *testing.T) {
		...
		psi := domain.PsiUserModel{
			...
			Genre: "F", Nationality: "V", ContactEmail: "upd@t.com", FirstName: "Upd", LastName: "User",
	...
	t.Run("SearchAdmin ignores filters", func(t *testing.T) {
		...
		tx.Create(&domain.PsiUserModel{
			...
			Nationality: "V", ContactEmail: "a1@t.com", FirstName: "A1", LastName: "T1", BioTextID: dummyBio.ID,
		})

		tx.Create(&domain.PsiUserModel{
			ID: uuid.New(), Username: "a2", Email: "a2@t.com", CI: 2, FPV: 200,
			Solvent: true, IsActive: false, BornDate: now, Genre: "F",
			Nationality: "V", ContactEmail: "a2@t.com", FirstName: "A2", LastName: "T2", BioTextID: dummyBio.ID,
		})
