...
-- Create index "idx_notification_targets_notification_id" to table: "notification_targets"
CREATE INDEX "idx_notification_targets_notification_id" ON "notification_targets" ("notification_id");
-- Create index "idx_notification_targets_psi_user_id" to table: "notification_targets"
CREATE INDEX "idx_notification_targets_psi_user_id" ON "notification_targets" ("psi_user_id");
-- Create "posts" table
CREATE TABLE "posts" (
  "id" uuid NOT NULL DEFAULT uuidv7(),
  "created_at" timestamptz NULL,
