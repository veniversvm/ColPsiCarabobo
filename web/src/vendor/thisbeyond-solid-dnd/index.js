...
var createPointerSensor = (id = "pointer-sensor") => {
  ...
  // PATCH local: `attach` se declara ANTES del onMount() que lo referencia.
  // En el dist original (0.7.5) está después y con Solid 1.9 los efectos se
  // ejecutan eager durante el render → TDZ "Cannot access 'attach' before
  // initialization". Ver web/src/vendor/thisbeyond-solid-dnd/README.md.
