...
export default function Navbar() {
  ...
  const navLinkClass = "text-colpsi-blue hover:bg-blue-50 md:hover:bg-transparent md:hover:text-blue-700 block px-3 py-4 md:py-0 rounded-md text-base font-medium transition-colors";
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
          ...
          <div class="hidden md:flex items-center space-x-5 lg:space-x-8">
            <A href="/directorio" class="text-gray-600 hover:text-colpsi-blue font-medium transition-colors">Directorio</A>
            <A href="/noticias" class="text-gray-600 hover:text-colpsi-blue font-medium transition-colors">Noticias</A>
            <A href="/inscripcion" class="text-gray-600 hover:text-colpsi-blue font-medium transition-colors">Inscripción</A>
            <A href="/nosotros" class="text-gray-600 hover:text-colpsi-blue font-medium transition-colors">Nosotros</A>
            <A href="/documentos" class="text-gray-600 hover:text-colpsi-blue font-medium transition-colors">Marco Legal</A>
            
            <Show 
              when={isAuthenticated()} 
              fallback={
                <A href="/login" class="bg-colpsi-yellow text-colpsi-blue px-5 py-2 rounded-full font-bold shadow-sm hover:shadow-md hover:bg-colpsi-yellow-dark transition-all ml-2">
                  Iniciar Sesión
                </A>
              }
            >
              <div class="flex items-center gap-4 border-l pl-6 border-gray-100">
                ...
                <A href={role() === 'admin' ? '/admin' : '/psi'} class="text-right flex flex-col group">
                  ...
                  <span class="text-sm font-bold text-colpsi-blue group-hover:underline">
                ...
                <Show 
                  when={role() === "admin"}
                  fallback={
                    <A href="/psi" class="text-xs bg-blue-50 text-colpsi-blue px-3 py-1.5 rounded-lg font-bold hover:bg-colpsi-yellow transition-colors uppercase">
                      Mi Perfil
                    </A>
                  }
                >
          ...
          <div class="flex md:hidden">
            <button 
              ...
              class="inline-flex items-center justify-center p-2 rounded-md text-colpsi-blue hover:bg-blue-50 focus:outline-none transition-colors"
            >
          ...
          <div class="px-4 pt-4 pb-6 space-y-1">
            ...
            <div class="my-4 border-t border-gray-100 pt-4">
              <Show 
                when={isAuthenticated()} 
                fallback={
                  <A href="/login" onClick={() => setIsOpen(false)} class="block w-full text-center bg-colpsi-yellow text-colpsi-blue px-4 py-4 rounded-2xl font-black shadow-lg shadow-yellow-500/20 mt-2">
                    INICIAR SESIÓN
                  </A>
                }
              >
                <div class="space-y-4">
                  ...
                  <A href="/psi/me" onClick={() => setIsOpen(false)} class="block w-full bg-blue-50 text-colpsi-blue px-4 py-3 rounded-xl font-bold text-center border border-blue-100">
                    Gestionar Mi Perfil
                  </A>
