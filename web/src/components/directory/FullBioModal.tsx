  ...
  return (
    <Presence>
      <Show when={props.isOpen && props.content}>
        ...
        >
          <Animate variant="zoom" class="bg-white rounded-[2rem] shadow-2xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden border border-gray-100" exit={{ opacity: 0, scale: 0.95 }}>
