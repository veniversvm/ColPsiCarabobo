// web/src/components/admin/psicologos/edit/ObservationsBlock.tsx

import { For, Show, createSignal } from "solid-js";
import type { ObservacionesEntry } from "./types";

interface Props {
  entries: ObservacionesEntry[] | undefined;
...
export function ObservationsBlock(props: Props) {
  ...
  const startEdit = (entry: ObservacionesEntry) => {
    if (!entry.id) return;
  ...
  const saveEdit = async (entry: ObservacionesEntry) => {
