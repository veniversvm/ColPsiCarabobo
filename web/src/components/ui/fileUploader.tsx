...
export const FileUploader = (props: { id: string, label: string, onChange: (e: Event) => void, file?: File }) => {
  return (
    <label class="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-2xl h-28 hover:border-colpsi-blue transition-all cursor-pointer bg-colpsi-surface/50">
