  ...
  return (
    <Show when={props.isOpen}>
      <Portal>
        {/* Overlay */}
        <div 
          class="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 animate-in fade-in"
          onClick={props.onClose}
        >
          {/* Modal */}
          <div 
            class="relative max-w-5xl w-full max-h-[90vh] animate-in zoom-in-95"
