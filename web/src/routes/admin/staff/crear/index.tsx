      ...
      <form onSubmit={handleSubmit} class="space-y-6">
        ...
        <section class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 space-y-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                type="text" required maxLength={25}
            ...
            <div>
              ...
              <input
                type="email" required
                placeholder="ej. jperez@colpsi.org"
                value={email()}
          ...
          <div>
            ...
            <p class="text-[10px] text-gray-400 mt-1 ml-1">
              El sistema enviará las credenciales al email del administrador.
            </p>
          </div>
        </section>
        ...
        <section class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
          <div class="flex items-center justify-between border-b border-gray-100 pb-3 mb-6">
            <h2 class="text-sm font-black text-blue-800 uppercase tracking-widest">
              Permisos
            </h2>
            <span class="text-xs font-black text-gray-500">
              {totalEnabled()}/15 activos
            </span>
          </div>
