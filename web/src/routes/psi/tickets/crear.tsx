...
export default function PsiCrearTicket() {
  ...
  return (
    <main class="bg-[#f8fafc] min-h-screen pb-24">
      <div class="bg-[#1e3a8a] pt-10 pb-16 px-6 mb-4">
      ...
      <div class="max-w-2xl mx-auto px-4">
        <div class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 space-y-5">
          <Suspense fallback={<div class="h-16 bg-gray-50 animate-pulse rounded-2xl" />}>
            ...
            <div>
              ...
              <select
                ...
                class="w-full px-4 py-3.5 rounded-2xl border-2 border-gray-100 bg-gray-50 outline-none focus:border-[#1e3a8a] text-sm font-semibold text-gray-800 transition-all"
              >
          ...
          <div>
            ...
            <label class="flex flex-col items-center justify-center gap-2 px-6 py-8 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50/60 cursor-pointer hover:border-[#1e3a8a] hover:bg-blue-50/40 transition-all">
